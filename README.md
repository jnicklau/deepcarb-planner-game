...
<!-- All rights reserved. -->
This project is licensed under the **Creative Commons Attribution-NonCommercial-NoDerivates 4.0 International (CC BY-NC-ND 4.0)** license.
...
- **NoDerivatives**  — You may **not** modify this project or its concepts.
